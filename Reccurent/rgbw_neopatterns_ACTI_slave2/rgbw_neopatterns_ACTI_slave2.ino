...
void setup()
{
  ...
  //Stick.Scanner(Stick.Color(255, 0, 0), 40); //~40 is a good delay
...
void receiveEvent(int howMany)
{
  ...
  switch (numFromMaster)
  {
    ...
    //act 5 complete
    case 5:
      Serial.println("Received message to fade out");
      //delay(50);
      //Stick.FadeOut(50, 10);
...
void StickComplete()
{
  switch (ACT)
  {
    ...
    case 3:
      if (firstTimeInACT3)
      {
        Stick.Scanner(Stick.Color(255, 255, 255), 50);
    ...
    case 4:
      ...
      {
        //start ACT 5
        Stick.Orbit(Stick.Color(255, 255, 255), 16);
